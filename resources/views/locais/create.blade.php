    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        <div class="container" style="padding-top: 100px; max-width: 600px;">
          ...
          <h2 class="text-center mb-4">Novo Local de Doação</h2>
          ...
          <form action="{{ route('locais-doacao.store') }}" method="POST">
            @csrf
            ...
            <button type="submit" class="btn btn-success">Salvar Local</button>
